...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM taikhoan WHERE MaTaiKhoan = '$id' AND TenDangNhap = '$username'";
    ...
    if (isset($_POST['capnhatthongtin'])) {
        ...
        if (mysqli_query($connection, $sql)) {
            echo '<div class="list">Cập nhật thông tin cá nhân thành công. <a href="/taikhoan/index.php?&id='.$id.'">Quay lại</a></div>';
            exit;
        } else {
            echo '<div class="list">Đã có lỗi xảy ra. <a href="/taikhoan/index.php?&id='.$id.'">Quay lại</a></div>';
            exit;
    }
    }
    ...
    echo '<h2>Cập nhật thông tin tài khoản</h2>';
