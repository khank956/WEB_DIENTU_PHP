<div id="vien">
    <div class="center">
        <div id="ban">
            ...
            <font color="#008744">Quản lý loại sản phẩm</font>
        </div>
    </div>
</div>
...
// 2. Tạo câu truy vấn (Query): SELECT, INSERT, DELETE, UPDATE
    ...
    echo '<div class="list">';
    echo '<a href="/qlyLoaiSP/index.php?mod=update&id=' . $row['MaLoaiSanPham'] . '"><button class="button">Sửa sản phẩm</button></a>';
    echo '<a href="/qlyLoaiSP/index.php?mod=del&id=' . $row['MaLoaiSanPham'] . '"><button class="button1">Xóa sản phẩm</button></a>';
    echo '</div>';
